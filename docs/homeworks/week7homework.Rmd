...
$\bf (10)$ A random variable $X$ follows a binomial distribution with probability of success $p = 0.43$ and number of trials $n = 8$. What is the probability of observing fewer than 3 success, that is what is $P(X \leq 3)$?
