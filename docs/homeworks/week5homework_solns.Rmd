...
<span style="color: red;">\[ z = \frac{423 - 355}{69} \approx 1\]. Therefore we ant to know what proportion of observations have a value $\geq 1s$ which is by the empirical rule is $13.5\%+2.5\% = 16\%$</span>
...
<span style="color: red;">The sample mean is $\bar{x} = 4.446$ and the sample standard deviation is $s = 0.188$ 
...
<span style="color: red;">approximately -2.8 and 13.1</span>
