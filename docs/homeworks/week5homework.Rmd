...
(a) Assume that the mean and standard deviation of $X$ are $\bar{x} = 5$ and $s = 4$. Find the $2.5th$ and $97.5th$ percentiles of $X$. You can use the plot above to verify your solution
