...
The final examination is on Monday, May. 6th, from 8:00 AM to 10:00 AM. It will be in the same room as lecture (Teaching and Learning Center, Room 22).
...
- Understand the distinction between **discrete** vs **continuous** variables
...
- Know the defining characteristics of the various sampling designs we've discussed i.e Convenience Sampling, Systematic Sampling, Simple Random Sampling, Cluster Sampling, Stratified Random Sampling
...
- Know how to compute a probability concerning a continuous random variable based on a plot of the probability density function (i.e., using the area under the curve).
- Understand the key features that define Bernoulli, Poisson, and Binomial random variables.
...
- Know how to compute the sample size required for estimating $p$ with $\hat{p}$ for a desired margin of error $m$
