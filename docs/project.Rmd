...
* Clarity and relevance of the chosen statistical question (5pts).
* Accuracy and completeness of the statistical description for each variable (5pts).
* Appropriateness of the chosen hypothesis and statistical test (5pts).
* Accuracy in conducting the statistical test and interpreting the results (5pts).
* Presentation quality of descriptive plots and written analysis (5pts).
