...
* Steps for constructing a boxplot:
  ...
  * From each end of the box, draw a line extending outward $1.5 \times IQR$. Any points extending beyond this line are marked with individual points and are considered outliers.
