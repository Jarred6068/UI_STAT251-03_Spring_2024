...
* What proportion of these confidence intervals are expected to contain to the true population mean accruacy. What proportion do not? The plot below gives the results of all $100$ confidence intervals 
...
The plot above gives $100$ confidence intervals at the $95\%$ confidence level. Each confidence interval is constructed from a sample of 100 simulated observations from the population the distribution of stormtrooper blaster accuracy. As we can see from above, all but two of the confidence intervals covers the true value of the parameter $\mu$ (denoted by the black dotted line).
